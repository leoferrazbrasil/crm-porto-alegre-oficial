...
export default async function PipelinePage() {
  ...
  return (
    <div className="appShell">
      <CrmSidebar adminName={adminName} activeItem="pipeline" />
      ...
      <main className="mainContent">
        ...
        <section className="pipelineSummaryGrid" aria-label="Resumo do pipeline">
        ...
        <section className="sectionBlock" aria-label="Quadro de oportunidades">
          <div className="sectionHeader">
            <div>
              <p className="eyebrow">Kanban de oportunidades</p>
          ...
          {leads.length ? (
            ...
            <div className="emptyState">
              ...
              <p>
                Cadastre a primeira oportunidade para alimentar o pipeline real do CRM.
              </p>
            </div>
          )}
        </section>
